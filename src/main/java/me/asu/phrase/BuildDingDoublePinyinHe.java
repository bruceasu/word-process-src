 ...
 * 小鹤
 */
public class BuildDingDoublePinyinHe {

    public static void main(String[] args) throws IOException {
//        String inFile = "D:\\suk\\Desktop\\2.txt";
        String inFile = "src/main/resources/带调拼音.txt";
        String outFile = "out\\a.txt";
                ...
                for (int i = 1; i < data.length; i++) {
                    ...
                    if (hasTone) {
                        ...
                        if (mapping.containsKey(newCode)) {
                            String str = mapping.get(newCode);
                            if (str.length() == 1) {
                                str = "e" + str;
                            }
                            builder.append(str + tone);
                        } else {
    ...
    static Map<String, String> makeTable() {
        ...
        s.forEach((k1, v1) -> w.forEach((k2, v2) -> m.put(k1 + k2, v1 + v2)));
